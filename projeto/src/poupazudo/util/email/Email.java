...
public class Email {
	 ...
	 * @param to The type of receiver (eg. {@link RecipientType#CC}).
	 * @see #recipients
	 * @see Recipient
	 * @see RecipientType
	 */
	public void addRecipient(final String name, final String address, final javax.mail.Message.RecipientType to) {
		recipients.add(new Recipient(name, address, to));
	}
